...
if($_SERVER['REQUEST_METHOD']=="POST"){
  ...
  if($aksi == "tambah") {
   ...
   $harga jual = $_POST['harga_jual'];
   $deskripsi = $_POST['deskripsi'];
   $sql = "INSERT INTO barang (id_pemasok, nama_barang, merk, ukuran, satuan, id_kategori, harga_beli, harga_jual, deskri psi_barang)VALUES('$idpemasok', '$namabarang', '$merk', '$ukuran', '$satuan', '$idkategori', '$harga beli', '$hargajual', '$deskripsi')";
  }elseif ($aksi=="edit"){
   $id = $_GET['id'];
   $idpemasok = $_POST['pemasok'];
   $namabarang = $_POST['nama_barang'];
