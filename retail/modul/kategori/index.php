            ...
            <div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                 <div class="modal-content">
                   ...
                   <div class="mb-3">
                   <label  class="form-label" for="nampemasok">Nama Kategori</label>
    ...
    <tbody>
        ...
        while($row_kategori = $result_kategori->fetch_assoc()){
            ...
            <td><?= $no; ?></td>
                ...
                <td><span class="badge <?= $row_kategori['status']== 1?'text-bg-success':'text-bg-danger';?>"><?= $row_kategori['status'] ==1?'Aktiv':'Tidak Aktiv'; ?></span></td>
        <td>
        <a href="" data-bs-toggle="modal" data-bs-target="#modalEdit<?= $row_kategori['id_kategori'];?>" 
             ...
             <div class="modal fade" id="modalHapus<?= $row_kategori['id_kategori'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-danger">Hapus ini</button>
                        </form>
                    </div>
                    </div>
                </div>
