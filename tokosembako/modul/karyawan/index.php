<div class="row mb-3">
    <div class="col">
        <h5 class="text-theme">Data Karyawan</h5>
    </div>
    <div class="col text-end">
        <a class="btn btn-theme" href="?modul=formtambah">Tambah Karyawan</a>
    </div>
</div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Apakah Anda yakin ingin menghapus data ini? <strong><?= $row['nama']; ?></strong>
                                    </div>
